<template>
  <!-- Header Area -->
  <header class="mb-12 border-b-2 border-foreground pb-6 w-full pt-4 relative">
    <div class="absolute -bottom-1.5 left-0 w-3 h-3 bg-foreground"></div>
    <div class="absolute -bottom-1.5 right-0 w-3 h-3 bg-foreground"></div>
