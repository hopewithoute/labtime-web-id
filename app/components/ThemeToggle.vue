...
<template>
  ...
  >
    ...
    <kbd class="hidden md:inline-block text-[10px] font-mono px-1 py-0.5 border border-foreground/30 text-muted-foreground group-hover:text-accent group-hover:border-accent/50 ml-1 transition-colors">⌘⇧T</kbd>
    <span class="opacity-0 group-hover:opacity-100 transition-opacity">]</span>
  </button>
</template>
